...
static inline void pid_rb_skiplist_init(struct pid_skiplist *sl, gfp_t gfp) {}
static inline void pid_rb_skiplist_destroy(struct pid_skiplist *sl) {}
...
#endif // CONFIG_PID_RB_SKIPLIST

#endif // _LINUX_PID_RB_SKIPLIST_H
